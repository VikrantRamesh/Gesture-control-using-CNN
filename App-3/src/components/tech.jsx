        ...
        <div class='h-100 grid grid-cols-8 gap-4 max-w-screen-xl content-start place-items-center align-top place-content-center mx-auto'>
            {/* <div class='mx-10 my-5  bg-gradient-to-r from-pink-500 via-purple-400 to-orange-400 rounded-full py-2 px-2 '> */}
                <div class=' bg-white content-start place-items-center align-top  border-solid border-0 rounded-full hover:shadow-lg  hover:shadow-slate-500 z-40'>
                    <div class=' px-4 py-4 '>
                            <img src= {Python} class='h-auto w-auto z-40'  onMouseOver={e =>handleChange(e,'Python',Python)}></img>         
                    </div>
                </div>

                <div class=' bg-white content-start place-items-center align-top  border-solid border-0 rounded-full hover:shadow-lg  hover:shadow-slate-500 z-40'>    
                        <div class='px-4 py-4'>
                                <img src= {Tensorflow} class='h-auto w-auto z-10 ' onMouseOver={e =>handleChange(e,'Tensorflow',Tensorflow)}></img>         
                        </div>
                </div>
                ...
                <div class=' bg-white content-start place-items-center align-top  border-solid border-0 rounded-full hover:shadow-lg  hover:shadow-slate-500 z-40'>    
                        <div class='px-4 py-4'>
                                <img src= {opencv} class='h-auto w-auto z-10'  onMouseOver={e =>handleChange(e,'OpenCV',opencv)}></img>         
                        </div>
                ...
                <div class=' bg-white content-start place-items-center align-top  border-solid border-0 rounded-full hover:shadow-lg  hover:shadow-slate-500 z-40'>    
                        <div class='px-4 py-4'>
                                <img src= {react} class='h-auto w-auto z-10 ' onMouseOver={e =>handleChange(e,'React',react)}></img>         
                        </div>
                </div>
                ...
                <div class=' bg-white content-start place-items-center align-top  border-solid border-0 rounded-full hover:shadow-lg  hover:shadow-slate-500 z-40'>
                    <div class='px-4 py-4'>
                            <img src= {Numpy} class='h-auto w-auto z-10'  onMouseOver={e =>handleChange(e,'Numpy',Numpy)}></img>         
                    </div>
                </div>

                <div class=' bg-white content-start place-items-center align-top  border-solid border-0 rounded-full hover:shadow-lg  hover:shadow-slate-500 z-40'>    
                        <div class='px-4 py-4'>
                                <img src= {mediapipe} class='h-auto w-auto z-10'  onMouseOver={e =>handleChange(e,'Mediapipe',mediapipe)}></img>         
                        </div>
                </div>
                ...
                <div class=' bg-white content-start place-items-center align-top  border-solid border-0 rounded-full hover:shadow-lg overflow-hidden hover:shadow-slate-500 z-40'>    
                        <div class=' px-4 py-4'>
                                <img src= {keras} class='h-auto w-auto z-10'  onMouseOver={e =>handleChange(e,'keras',keras)}></img>         
                        </div>
                </div>
                ...
                <div class=' bg-white content-start place-items-center align-top  border-solid border-0 rounded-full  z-40 hover:shadow-lg  hover:shadow-slate-500'>    
                        <div class=' px-4 py-4'>
                                <img src= {tailwind} class='h-auto w-auto z-10' onMouseOver={e =>handleChange(e,'Tailwind',tailwind)}></img>         
                        </div>
                </div>

        </div>
        <div class=' mx-auto max-w-screen-sm grid place-items-center py-20 z-40'>
                <img src= {lap} class='h-72 w-auto z-10'></img>    
