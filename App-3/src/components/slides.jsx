...
const Slide1 = () => {
  return (
    <div class = 'w-screen h-screen bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 slide  background-animate'>
        <div class="h-screen grid grid-cols-2 gap-6 content-start place-items-center align-top">
