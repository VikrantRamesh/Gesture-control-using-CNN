...
const Footer = () => {
    return (
    <div className = 'bg-gradient-to-t to-green-400 from-green-400 pt-4'>  
            
            <div className = 'h-2 max-w-screen-lg border-dotted bg-white rounded-lg mx-auto my-8 '></div>
            ...
            <footer className="p-4">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        ...
                        <svg className="fill-current h-8 w-8 mr-2" width="54" height="54" viewBox="0 0 54 54" ><path d="M13.5 22.1c1.8-7.2 6.3-10.8 13.5-10.8 10.8 0 12.15 8.1 17.55 9.45 3.6.9 6.75-.45 9.45-4.05-1.8 7.2-6.3 10.8-13.5 10.8-10.8 0-12.15-8.1-17.55-9.45-3.6-.9-6.75.45-9.45 4.05zM0 38.3c1.8-7.2 6.3-10.8 13.5-10.8 10.8 0 12.15 8.1 17.55 9.45 3.6.9 6.75-.45 9.45-4.05-1.8 7.2-6.3 10.8-13.5 10.8-10.8 0-12.15-8.1-17.55-9.45-3.6-.9-6.75.45-9.45 4.05z"/></svg>
                            ...
                            <span className="self-center text-5xl font-semibold text-gray-900 space-nowrap">GESTURES</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-white">
                                <li className="mb-4">
                                    <a href="https://github.com/VikrantRamesh/Gesture-control-using-CNN" className="hover:underline ">Github</a>
                                </li>
                                <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm sm:text-center text-white">© 2023 <a  className="hover:underline">GESTURES™</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://github.com/VikrantRamesh/Gesture-control-using-CNN" className="text-white hover:text-gray-900">
